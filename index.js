...
// 🔥 FORCE NAME
config.name = "HILOHOST";
config.ogTitle = "HILOHOST";
...
app.listen(config.port, () =>
  log.info(`HILOHOST is listening on port ${config.port}`)
);

app.get("*", async function (req, res) {
  res.render("errors/404", {
    req,
    name: "HILOHOST", // 🔥 forced
  });
});